...
int Battle_controller:: judge_end(int& iswin, int* before_attr) const//判断战斗是否结束、增加经验、升级
{
    ...
    if(pokemon1.zero_HP())
    {
        ...
        cout << "获胜。" << endl;
        cout << endl;
        before_attr[0] = pokemon2.check_grade();
        before_attr[1] = pokemon2.check_HP();
        before_attr[2] = pokemon2.check_ATK();
        before_attr[3] = pokemon2.check_DF();
        before_attr[4] = pokemon2.check_speed();
        before_attr[5] = pokemon2.check_EXP();
    ...
    else if(pokemon2.zero_HP())
    {
        ...
        cout << "获胜。" << endl;
        cout << endl;
        before_attr[0] = pokemon1.check_grade();
        before_attr[1] = pokemon1.check_HP();
        before_attr[2] = pokemon1.check_ATK();
        before_attr[3] = pokemon1.check_DF();
        before_attr[4] = pokemon1.check_speed();
        before_attr[5] = pokemon1.check_EXP();
